...
export default function LandingPage() {
  const features = [
    ...
    { icon: Cpu, title: "AI Portfolio Writer", desc: "No more writer's block. Our AI writes clean, engaging descriptions of your projects and experiences automatically." },
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] bg-grid-pattern text-white relative">
      {/* Background orbs — glassy orange + amber */}
      <div className="glow-orb w-[600px] h-[600px] -top-80 -left-60 bg-orange-500/12" />
      <div className="glow-orb w-[500px] h-[500px] top-[40%] right-[-100px] bg-amber-400/10" style={{ animationDelay: '-10s' }} />
      ...
      <section className="py-24 px-6 max-w-5xl mx-auto border-t border-white/5">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500/6 via-transparent to-amber-400/6 pointer-events-none" />
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-amber-500/30 bg-amber-500/6 text-amber-300 text-xs font-semibold mb-6">
              <Zap className="w-3.5 h-3.5" />
              <span>Free to Get Started</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">
              Your Portfolio is One <br />
              <span className="text-gradient-orange-yellow">Click Away.</span>
            </h2>
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-2 px-10 py-4 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-400 text-white font-bold hover:from-orange-400 hover:to-amber-300 transition-all duration-300 shadow-xl shadow-orange-500/25 text-sm group btn-glow"
            >
      ...
      <footer className="py-12 border-t border-white/5 text-center text-xs text-gray-500">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-gray-500 hover:text-amber-400 transition-colors duration-200 group"
        >
          <span>Built by</span>
          <span className="font-semibold text-gray-400 group-hover:text-amber-400 transition-colors">Tharun R</span>
